      ...
      <div id="SaveTime" className="sm:pb-16 pb-12 md:pt-20 pt-12">
        <div className="max-w-[960px] w-[92vw] m-auto flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            <iframe class="ev-video-stream-player-iframe w-full h-[458px]" id="video-stream-player-id-654223b7e93c83c8d42d4a27" frameborder="0" allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" title="Boost your efficiency in Gmail" width="640" height="360" src="https://www.youtube.com/embed/GQOjcm7-csI?autoplay=0&amp;cc_lang_pref&amp;cc_load_policy=0&amp;color=red&amp;disablekb=0&amp;enablejsapi=1&amp;fs=1&amp;hl&amp;loop=0&amp;modestbranding=0&amp;origin=https%3A%2F%2Fskillshop.exceedlms.com&amp;playsinline=1&amp;rel=0&amp;start=0&amp;widgetid=1" data-gtm-yt-inspected-11="true"></iframe>
