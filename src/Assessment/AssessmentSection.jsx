        ...
        <div className="max-w-[960px] w-[92vw] m-auto flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            <article className="flex flex-col gap-5 relative">
                ...
                <video preload="auto" controls   src="https://skillshop.exceedlms.com/uploads/resource_courses/targets/1862197/original/course/en/assets/64b68e5b3139e0103e0a198b/video.mp4" tabindex="-1" onPlay={handleVideoPlay} onPause={handleVideoPause} />
